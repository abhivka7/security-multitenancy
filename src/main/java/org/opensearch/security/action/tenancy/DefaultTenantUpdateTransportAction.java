...
public class DefaultTenantUpdateTransportAction extends HandledTransportAction<StringSettingUpdateRequest, StringSettingRetrieveResponse> {

    private static final Logger log = LogManager.getLogger(DefaultTenantUpdateTransportAction.class);
    ...
    @Inject
    public DefaultTenantUpdateTransportAction(final Settings settings,
                                             final TransportService transportService,
                                             final ActionFilters actionFilters,
                                             final ConfigurationRepository config,
                                             final ThreadPool pool,
                                             final Client client) {
        super(DefaultTenantUpdateAction.NAME, transportService, actionFilters, StringSettingUpdateRequest::new);
    ...
    @Override
    protected void doExecute(final Task task, final StringSettingUpdateRequest request, final ActionListener<StringSettingRetrieveResponse> listener) {
        ...
        config.dynamic.kibana.default_tenant = request.getValue();
            ...
            AbstractApiAction.saveAndUpdateConfigs(this.securityIndex, this.client, CType.CONFIG, dynamicConfig, new ActionListener<IndexResponse>(){
                ...
                public void onResponse(final IndexResponse response) {
                    ...
                    try {
                        ...
                        client.execute(DefaultTenantRetrieveAction.INSTANCE, new EmptyRequest(), listener);
