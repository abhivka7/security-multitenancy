...
public class DefaultTenantRetrieveTransportAction
        extends HandledTransportAction<EmptyRequest, StringSettingRetrieveResponse> {

    private final ConfigurationRepository config;

    @Inject
    public DefaultTenantRetrieveTransportAction(final Settings settings,
                                               final TransportService transportService,
                                               final ActionFilters actionFilters,
                                               final ConfigurationRepository config) {
        super(DefaultTenantRetrieveAction.NAME, transportService, actionFilters, EmptyRequest::new);
    ...
    @Override
    protected void doExecute(final Task task, final EmptyRequest request, final ActionListener<StringSettingRetrieveResponse> listener) {
        ...
        final String value = config.dynamic.kibana.default_tenant;

        listener.onResponse(new StringSettingRetrieveResponse(value));
    }
}
