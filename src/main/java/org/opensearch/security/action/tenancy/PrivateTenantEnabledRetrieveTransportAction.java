...
public class PrivateTenantEnabledRetrieveTransportAction
        extends HandledTransportAction<EmptyRequest, BooleanSettingRetrieveResponse> {

    private final ConfigurationRepository config;

    @Inject
    public PrivateTenantEnabledRetrieveTransportAction(final Settings settings,
                                               final TransportService transportService,
                                               final ActionFilters actionFilters,
                                               final ConfigurationRepository config) {
        super(PrivateTenantEnabledRetrieveAction.NAME, transportService, actionFilters, EmptyRequest::new);
    ...
    protected void doExecute(final Task task, final EmptyRequest request, final ActionListener<BooleanSettingRetrieveResponse> listener) {
        ...
        final Boolean value = config.dynamic.kibana.private_tenant_enabled;
