...
public class PrivateTenantEnabledUpdateTransportAction extends HandledTransportAction<BooleanSettingUpdateRequest, BooleanSettingRetrieveResponse> {

    private static final Logger log = LogManager.getLogger(PrivateTenantEnabledUpdateTransportAction.class);
    ...
    @Inject
    public PrivateTenantEnabledUpdateTransportAction(final Settings settings,
                                             final TransportService transportService,
                                             final ActionFilters actionFilters,
                                             final ConfigurationRepository config,
                                             final ThreadPool pool,
                                             final Client client) {
        super(PrivateTenantEnabledUpdateAction.NAME, transportService, actionFilters, BooleanSettingUpdateRequest::new);
    ...
    protected void doExecute(final Task task, final BooleanSettingUpdateRequest request, final ActionListener<BooleanSettingRetrieveResponse> listener) {
        ...
        config.dynamic.kibana.private_tenant_enabled = request.getValue();
            ...
            AbstractApiAction.saveAndUpdateConfigs(this.securityIndex, this.client, CType.CONFIG, dynamicConfig, new ActionListener<IndexResponse>(){
                ...
                public void onResponse(final IndexResponse response) {
                    ...
                    try {
                        ...
                        client.execute(PrivateTenantEnabledRetrieveAction.INSTANCE, new EmptyRequest(), listener);
