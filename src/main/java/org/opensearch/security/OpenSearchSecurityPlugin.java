...
public final class OpenSearchSecurityPlugin extends OpenSearchSecuritySSLPlugin implements ClusterPlugin, MapperPlugin {
    ...
    public List<Setting<?>> getSettings() {
        ...
        if(!SSLConfig.isSslOnlyMode()) {
            ...
            log.info("************** Tenancy_abhivka Add tenancyconfig settings");
            settings.add(Setting.listSetting(ConfigConstants.SECURITY_TENANCY_CONFIG, Collections.emptyList(), Function.identity(), Property.NodeScope));//not filtered here
            log.info("************** Tenancy_abhivka Added tenancyconfig settings");
