...
public class TenancyMultitenancyEnabledTests extends SingleClusterTest {
    ...
    public void testMultitenancyDisabled_endToEndTest() throws Exception {
        ...
        final HttpResponse getSettingResponse = nonSslRestHelper().executeGetRequest("/_plugins/_security/api/tenancy/multitenancy_enabled", asAdminUser);
        ...
        final HttpResponse updateMutlitenancyToDisabled = nonSslRestHelper().executePutRequest("/_plugins/_security/api/tenancy/multitenancy_enabled", "{\"value\": \"false\"}", asAdminUser);
        assertThat(getSettingResponse.getStatusCode(), equalTo(HttpStatus.SC_OK));
    ...
    public void testForbiddenAccess() throws Exception {
        ...
        final HttpResponse getSettingResponse = nonSslRestHelper().executeGetRequest("/_plugins/_security/api/tenancy/multitenancy_enabled", asUser);
        ...
        final HttpResponse updateSettingResponse = nonSslRestHelper().executePutRequest("/_plugins/_security/api/tenancy/multitenancy_enabled", "{\"value\": \"false\"}", asUser);
